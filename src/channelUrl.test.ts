...
// Vector generado con el mismo schema → prueba decode + wiring del protobuf.
...
// base64url SIN padding, como hacen las URLs reales de Meshtastic
...
// atob se usa en b64urlToBytes; en node <20 no existe pero en 22 sí
...
// acepta solo el fragmento
assert.equal(parseChannelSetUrl(b64url).settings.length, 2, "sin prefijo URL");

// padding: longitudes que exigen 1,2,3 bytes de relleno
...
// roundtrip export → import: la URL generada se re-parsea igual
